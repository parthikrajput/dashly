                                                    ...
                                                    <div>
                                                        <ul class="nav nav-pills nav-fill">
                                                            <li class="m-1 border rounded nav-item">
                                                                <a @class(['nav-link', 'active' => $level == 'Direct level']) aria-current="page"
                                                                    href="#" wire:click.prevent="changeLevel('Direct level')">Direct level</a>
                                                            </li>
                                                            <li class="m-1 border rounded nav-item">
                                                                ...
                                                                <tbody>
                                                                    @forelse ($downlines as $ref)
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a wire:click.prevent="showDetails({{ $ref['id'] }})" href=""
