...
@section('content')
    <div class="row align-items-center justify-content-around vh-100" x-data="{ recovery: false }">
        <div class="py-6 col-11 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3">
            @if ($errors->any())
            ...
            @endif
            <!-- Title -->
            <h1 class="mb-2 text-center">2-step verification</h1>
            <!-- Heading -->
            <p class="text-center text-secondary" x-show="! recovery">
            ...
            <form method="POST" action="{{ route('two-factor.login') }}">
                ...
                <div class="text-center row align-items-center">
                    <div class="col-12">
                        <!-- Button -->
                        <button type="submit" class="mt-3 mb-2 btn w-100 btn-primary">Verify & sign in</button>
                    </div>
                </div> <!-- / .row -->
                <!--end row-->
            </form>
